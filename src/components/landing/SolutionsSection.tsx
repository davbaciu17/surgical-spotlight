...
// ─── Window chrome (matches HowItWorksSection style) ─────────────────────────
...
function StatBlock({ value, line1, line2 }: { value: string; line1: string; line2: string }) {
  return (
    ...
    >
      <p className="font-syne text-base font-bold text-white leading-none mb-1 truncate">
        {value}
      </p>
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 40px 80px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,86,0,0.03)",
        }}
      >
        ...
        <div className="p-4 space-y-3">
          ...
          >
            ...
            {/* Actions */}
            <div className="flex items-center gap-4 pb-3 border-b" style={{ borderColor: "rgba(255,255,255,0.05)" }}>
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <span
                  className="text-[10px] font-plex font-semibold"
                  style={{ color: "#00E5A0" }}
                >
                  u/local_foodie
                </span>
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg, transparent, rgba(255,86,0,0.08), transparent)",
          filter: "blur(2px)",
        }}
      />
    </motion.div>
...
// ─── Visual 2: Content Calendar ───────────────────────────────────────────────
// February 2026: Feb 1 = Sunday → in Mon-start layout it occupies column 7
const FEB_WEEKS = [
    ...
    >
      <div
        ...
        style={{
          background: "#131315",
          border: "1px solid rgba(255,255,255,0.07)",
          boxShadow: "0 40px 80px rgba(0,0,0,0.45), 0 0 0 1px rgba(0,184,212,0.03)",
        }}
      >
        ...
        <div className="p-4 space-y-3">
            ...
            {FEB_WEEKS.map((week, wi) => (
              <div key={wi} className="grid grid-cols-7">
                {week.map((day, di) => (
                  <div
                    key={di}
                    className="flex flex-col items-center justify-center py-[3px]"
                  >
                    {day !== null && (
                      <>
                        <span
          ...
          {/* Article preview card — slides up from below */}
          <motion.div
            className="rounded-xl p-4"
            style={{
              background: "#1C1C1E",
            ...
            <div className="space-y-1.5">
              {SCHEMA_ITEMS.map((item, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  >
                    {checked[i] && (
                      <Check className="w-2.5 h-2.5" style={{ color: "#00E5A0" }} />
                    )}
                  </div>
                  <span
      ...
      <div
        className="mx-auto h-px w-2/3 mt-0"
        style={{
          background: "linear-gradient(90deg, transparent, rgba(0,184,212,0.08), transparent)",
          filter: "blur(2px)",
        }}
      />
    </motion.div>
              ...
              {(platform.desc || platform.showKeywords) && (
                <div className="px-3 py-2.5" style={{ background: platform.bodyBg }}>
                  <div className="flex items-center gap-2 mb-1.5">
                    <span className="text-xs font-plex font-semibold text-white">
                      Bella Italia
                    </span>
                    <span className="text-[10px] font-plex" style={{ color: "#3A3A45" }}>
                      {platform.meta}
                  ...
                  {platform.desc && platform.desc.length > 0 && (
                    <p
...
function Solution({ tag, title, description, stats, textSide, children }: SolutionProps) {
  const ref = useRef<HTMLDivElement>(null);
  const inView = useInView(ref, { once: true, margin: "-80px" });
  ...
  const textBlock = (
    ...
    >
      <span
        className="font-mono text-[10px] font-semibold tracking-[0.18em] mb-5 block uppercase"
        style={{ color: "#00E5A0" }}
      >
        {tag}
      </span>
      ...
      <p
        className="font-plex text-[15px] leading-relaxed mb-6"
      ...
      <div className="container mx-auto px-4 max-w-[1080px]">
        ...
        <div className="space-y-24 md:space-y-32">
          ...
          <Solution
            ...
            description="Postări automate pe Reddit care pun afacerea ta în conversațiile din care AI-ul învață. Reddit este sursa #1 din care ChatGPT și Perplexity extrag recomandări locale — noi te introducem în aceste conversații natural și constant."
            stats={[
          ...
          <Solution
            ...
            description="Un plan editorial complet: articole optimizate pentru AI, structurate cu schema markup, FAQ și headere pe care motoarele AI le pot cita direct. Fiecare articol țintește exact interogările unde afacerea ta nu apare încă."
            stats={[
        ...
        {/* Section CTA */}
        <motion.div
          className="relative text-center mt-24 md:mt-32"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
