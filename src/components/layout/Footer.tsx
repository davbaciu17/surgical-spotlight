        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Prima platformă de vizibilitate AI pentru piața din România
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="#how-it-works" className="text-muted-foreground hover:text-foreground transition-colors">Cum funcționează</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Integrări</a></li>
            </ul>
          </div>
